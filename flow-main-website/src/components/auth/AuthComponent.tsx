...
// // Component that uses searchParams - this needs to be wrapped in Suspense
// function AuthForm({
//   isAdmin = false,
//   isSignUp = false,
// }: {
...
// }) {
//   const router = useRouter();
//   const searchParams = useSearchParams(); // This line needs to be inside Suspense
//   const redirect = searchParams.get("redirect") || "/";
//   console.log("This is the redirect: ", redirect);
...
//   return (
//     <Suspense fallback={<Spinner />}>
//       <AuthForm isAdmin={isAdmin} isSignUp={isSignUp} />
//     </Suspense>
//   );
// };
